...
ComputeStyle(diamondorder/atom,ComputeDiamondOrderAtom)

#else

#ifndef LMP_COMPUTE_DIAMONDORDER_ATOM_H
#define LMP_COMPUTE_DIAMONDORDER_ATOM_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeDiamondOrderAtom : public Compute {
 public:
  ComputeDiamondOrderAtom(class LAMMPS *, int, char **);
  ~ComputeDiamondOrderAtom();
  void init();
